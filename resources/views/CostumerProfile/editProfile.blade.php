                ...
                <div class="container-fluid mt-4 text-center">
                    <div class="container-fluid mt-2 isi text-center">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-5">
                                <input type="file" class="form-control @error('imgProfile') is-invalid @enderror"
                                    name="imgProfile" value="{{ old('imgProfile', $user->imgProfile) }}">
                                @error('imgProfile')
                        ...
                        <div class="row ">
                            ...
                            <div class="col-5">
                                <input type="number" class="form-control @error('noTelp') is-invalid @enderror"
                                    name="noTelp" value="{{ old('noTelp', $user->noTelp) }}">
                                @error('noTelp')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
