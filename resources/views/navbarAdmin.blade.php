        ...
        <div class="container-fluid">
            ...
            <div class="btn-group">
                ...
                <ul class=" dropdown-menu dropdown-menu-lg-end" style="background-color: #03213B;">
                    <li><a class=" dropdown-item" href="{{ url('loginAdmin') }}" style="color: white;" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fas fa-sign-out-alt"></i>
                            Logout</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="background-color:#03213B !important;">
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ route('AdminIndex.index') }}"><iconify-icon icon="eos-icons:admin"></iconify-icon>Admin Page</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('Admin.index') }}"><iconify-icon icon="material-symbols:movie"></iconify-icon>Daftar Film</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('UserControl') }}"><iconify-icon icon="mdi:user-access-control"></iconify-icon>User Control</a>
                </li>
            </ul>
