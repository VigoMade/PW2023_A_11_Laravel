                    ...
                    <div class="col-lg-12">
                        <div class="row containerBody" style="margin-top: 120px;">
                            <div class="col-md-6 filmBioskop">
                                ...
                                <div class="promoVoucher">
                                    ...
                                    <div style="display: flex; align-items: center">
                                        <img src="{{asset('imgTransaksi2/logoDana.png')}}" alt="" width="30px" height="30px">
                                ...
                                <div class="timePayment" style="padding-left: 0px 10px; height: 20px;">
                                    <div style="display: flex">
                                        ...
                                        <span id="countdown" style="color: rgb(237, 100, 100); padding-left: 20px;"></span></p>
                            ...
                            <div class="col-md-4" style="text-align: center">
                                <div class="">
                                    <img style="border-radius: 20px" src="/img/{{ $movieFind->imageMovie }}" alt="" width="300px">
                        ...
                        <div class="container mb-5">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-xl-8">
                                        <ul class="list-unstyled">
                                            <li class="text-muted">To: <span style="color:#8f8061 ;">{{ $user->nama }}</span>
                                            </li>
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="text-muted"><i class="fas fa-circle" style="color:#8f8061;"></i>
                                                <span class="me-1 fw-bold">Status:</span><span class="badge bg-primary text-white fw-bold">
                                                    Paid</span>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3">
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Admin</span>Rp. 4000</li>
                                        </ul>
                                    ...
                                    <div class="col-xl-9">
                                        <center>
                                            <p style="margin-left:40%"><Strong>Ticket Dapat discan melalui My Ticket</Strong></p>
                                        </center>
                                    </div>
